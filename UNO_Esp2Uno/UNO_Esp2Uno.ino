...
// This sketch is for testing the serial communication between the esp32 and an arduino uno.
...
// Just connect the tx pin of the esp32 to the rx pin of the arduino UNO (resistor is not needed in this way)
// And the ground, that's it !


int led(13); // This is the pin of the onBoard led of the arduino uno
void setup () {
